      ...
      <div class="form-group" class="card">
        <form id="formcontribuyentes-edit" action="">
          ...
          <div id="boton-edit">
            ...
            <button onclick="sendEdit()" id="btnEdit" class="btn btn-blue">Guardar</button>
          </div>
      </div>
    </div>
  </div>
...
const setTableContribuyentes = (contribuyentes) => {
  ...
  for (let i = 0; i < contribuyentes.length; i++) {
    ...
    list += `<tr>
        ...
        <button class="btn btn-blue btn-sm" onclick="editContribuyente(${
          contribuyente.id
        })">editar</button>
        <button class="btn btn-danger btn-sm" onclick="deleteContribuyente(${
          contribuyente.id
        })">eliminar</button>
        </th>
        </tr>`;
...
const lisVisitas = (data) => {
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    <btn class="btn btn-blue btn-sm "onclick="alert('Observaciones: ${
      visita.observacion
    }')"> observaciones  
      </btn>
    </th>
...
const addContribuyente = async () => {
  try {
    ...
    alerta.innerHTML += ` <div
      ...
      id=""
    >
    <strong>Exitoso!</strong> Contribuyente agregado
      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
    </div>`;
...
const sendEdit = async () => {
  try {
    ...
    id=""
  >
  <strong>Exitoso!</strong> Contribuyente editado
    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
      <span aria-hidden="true">&times;</span>
    </button>
  </div>`;
